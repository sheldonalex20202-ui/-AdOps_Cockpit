...
export function GetAIConversations():Promise<Array<any>>;

export function LoadAIConversation(arg1:string):Promise<Array<any>>;

export function DeleteAIConversation(arg1:string):Promise<boolean>;
